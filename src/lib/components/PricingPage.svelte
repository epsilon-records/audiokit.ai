<script lang="ts">
  ...
  import { SignedIn, SignedOut, ClerkLoading } from 'svelte-clerk';
  ...
  const pricingTiers: PricingTier[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Exclusive sync opportunities', icon: '🎬' },
        { text: 'Up to 5 team members', icon: '🤝' },
...
<div class="relative">
  ...
  <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
      ...
      <div class="grid md:grid-cols-2 gap-4">
        {#each [0, 1] as i}
          <div
            ...
            class="relative flex flex-col rounded-xl border p-4 shadow-sm bg-white animate-pulse"
          >
      ...
      <div class="mt-8">
        {#each pricingTiers.slice(2) as tier}
          <div
            ...
            class="relative flex flex-col rounded-xl border p-4 shadow-sm bg-white col-span-2"
            class:ring-2={tier.highlighted}
            class:ring-primary={tier.highlighted}
          >
    ...
    <SignedIn>
      <div class="grid md:grid-cols-2 gap-4">
        {#each pricingTiers.slice(1, 3) as tier, i}
          <div
            in:fly={{ y: 20, duration: 600, delay: i * 200 }}
            class="relative flex flex-col rounded-xl border p-4 shadow-sm bg-white"
            class:ring-2={tier.highlighted}
          ...
          >
            ...
            <SignedIn>
              ...
              {:else}
                <a
                  href="/sign-up"
                  class="block w-full rounded-lg px-4 py-2 text-center text-sm font-semibold transition-colors bg-gray-50 text-gray-900 hover:bg-gray-100"
                >
