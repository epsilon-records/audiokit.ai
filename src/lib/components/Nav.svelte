        ...
        {:else}
          <SignedIn>
            <li class="pt-0.5">
              <a
                href="/join"
                class="flex btn btn-sm items-center gap-1.5 rounded-lg bg-gray-100 px-3 py-1.5 text-gray-900 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600"
              >
                <svg
                  class="h-4 w-4"
                  fill="none"
                ...
                >
                  <path
                    ...
                    stroke-width="2"
                    d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.75 21.75l-.144-1.182a2.25 2.25 0 00-1.51-1.513L13.75 18l1.183-.144a2.25 2.25 0 001.513-1.513L16.75 15l.144 1.183a2.25 2.25 0 001.513 1.513L19.75 18l-1.183.144a2.25 2.25 0 00-1.513 1.513z"
                  />
                </svg>
                <span>Enable Distribution</span>
              </a>
            </li>
            <li class="pt-1">
              <a
