...
export const socialPlatforms = [
  { id: 'website', label: 'Website', placeholder: 'Personal Website URL' },
  { id: 'instagram', label: 'Instagram', placeholder: 'Instagram URL' },
  { id: 'facebook', label: 'Facebook', placeholder: 'Facebook URL' },
  { id: 'x', label: 'X (Twitter)', placeholder: 'X Profile URL' },
  { id: 'tiktok', label: 'TikTok', placeholder: 'TikTok Profile URL' },
