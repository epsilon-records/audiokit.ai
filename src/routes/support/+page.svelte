...
<svelte:head>
  <title>Support | AudioKit</title>
  <meta name="description" content="Get support from the AudioKit team" />
</svelte:head>
...
<div class="relative min-h-[80vh] flex items-center">
  ...
  <div class="container max-w-4xl mx-auto px-4 py-16">
    <div class="text-center mb-12" in:fade={{ duration: 800 }}>
      ...
      <p
        class="text-muted-foreground max-w-2xl mx-auto text-lg bg-background/80 backdrop-blur-sm py-2 px-4 rounded-lg inline-block"
      >
    ...
    <div>
      {#if hasActiveSubscription}
        <div
          ...
          class="relative overflow-hidden rounded-xl border border-border/40 bg-gradient-to-br from-blue-50 via-slate-50 to-cyan-50 dark:from-blue-950/50 dark:via-slate-950/50 dark:to-cyan-950/50 p-12 text-center hover:shadow-lg transition-all duration-300"
        >
          <div class="relative z-10">
            <h2 class="text-2xl font-bold mb-4">Premium Support 💫</h2>
            <div class="flex items-center justify-center gap-2 mb-6">
              <svg
                role="img"
                viewBox="0 0 24 24"
                class="w-5 h-5 text-[#5865F2] fill-current"
                aria-label="Discord icon"
              >
                <path d={siDiscord.path} />
              </svg>
              <p class="text-muted-foreground">24/7 Private Discord Channel Access</p>
            </div>
            <a
              href="https://discord.gg/yWggeKMx"
              target="_blank"
              rel="noopener noreferrer"
              class="group inline-flex items-center text-2xl font-medium text-primary hover:text-primary/80 transition-colors"
            >
              Join Discord Server
              <ExternalLink class="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" />
            </a>
          </div>
        </div>
      {/if}
      ...
      <div
        in:fly={{ y: 20, duration: 600, delay: 400 }}
        class="mt-8 relative overflow-hidden rounded-xl border border-border/40 bg-gradient-to-br from-violet-50 via-slate-50 to-indigo-50 dark:from-violet-950/50 dark:via-slate-950/50 dark:to-indigo-950/50 p-12 text-center hover:shadow-lg transition-all duration-300"
      >
        <div class="relative z-10">
          <h2 class="text-2xl font-bold mb-4">Email Support ✉️</h2>
          ...
          <a
            href="mailto:support@audiokit.ai"
            class="group inline-flex items-center text-2xl font-medium text-primary hover:text-primary/80 transition-colors"
          >
            support@audiokit.ai
            <ExternalLink class="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" />
    ...
    >
      <div class="relative z-10">
        ...
        <p class="text-muted-foreground mb-6">
          Check out our comprehensive FAQ section and API documentation for quick solutions to
          common questions.
        </p>
        <div class="flex items-center justify-center gap-4">
          <a href="/faq" class="btn btn-primary inline-flex items-center justify-center gap-2">
