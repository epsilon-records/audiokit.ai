  ...
  <div class="container mx-auto px-4 pt-32 pb-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div class="flex flex-col gap-6">
        ...
        <ArtistInfoField 
          label="Real Name" 
          value={data.artist.legal_name} 
        />
        
        <ArtistInfoField 
          label="Biography" 
          value={data.artist.biography} 
        />
        
        <ArtistInfoField 
          label="Location" 
          value={data.artist.country} 
        />
        
        <ArtistSocialLinks 
          links={[
            ...(data.artist.soundcloud ? [{ platform: 'soundcloud', url: data.artist.soundcloud }] : []),
            ...(data.artist.instagram ? [{ platform: 'instagram', url: data.artist.instagram }] : []),
