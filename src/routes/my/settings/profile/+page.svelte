    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
      ...
      <div class="form-control w-full max-w-lg mb-2">
        <Field {form} name="email">
          ...
          <Description class="text-sm">It's preferred that you use your company email.</Description>
          <FieldErrors class="font-bold text-destructive mt-1" />
        </Field>
      </div>
      <div class="form-control w-full max-w-lg mb-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-2">
      ...
      <div class="form-control w-full max-w-lg mb-2">
        <Field {form} name="bandsintown">
          ...
          <Description class="text-sm">Your Bandsintown artist profile for tour dates.</Description>
          <FieldErrors class="font-bold text-destructive mt-1" />
        </Field>
      </div>
    </div>
