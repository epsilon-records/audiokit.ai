...
<div class="container mx-auto px-4 py-8">
  <h1 class="text-4xl font-bold tracking-tight text-center">Coming soon...</h1>
        ...
        <Card class="transition-all duration-200 hover:shadow-lg hover:scale-[1.02]">
          ...
          <CardContent class="pt-6">
            {#if streaming.spotify.items.length >= 2}
              {@const lastValue = streaming.spotify.items[streaming.spotify.items.length - 1].value}
              {@const prevValue = streaming.spotify.items[streaming.spotify.items.length - 2].value}
